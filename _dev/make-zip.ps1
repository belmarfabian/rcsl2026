...
$files = Get-ChildItem -Path "G:\Mi unidad\CEP\5_Servicio_Academico\5.1_RCSL_2026\web" -File | Where-Object { $_.Name -notmatch '^\.' -and $_.Name -ne 'rcsl2026-sitio-udp.zip' -and $_.Name -ne 'robots.txt' }
